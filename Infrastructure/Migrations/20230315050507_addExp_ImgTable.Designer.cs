...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230315050507_addExp_ImgTable")]
    partial class addExp_ImgTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Models.Experience_Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_experience_images");

                    b.HasIndex("ExperienceId")
                        .HasName("ix_experience_images_experience_id");

                    b.HasIndex("ImageId")
                        .HasName("ix_experience_images_image_id");

                    b.ToTable("experience_images");
                });
            ...
            modelBuilder.Entity("Infrastructure.Models.Experience_Image", b =>
                {
                    b.HasOne("Infrastructure.Models.Experience", "Experience")
                        .WithMany()
                        .HasForeignKey("ExperienceId")
                        .HasConstraintName("fk_experience_images_experiences_experience_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Infrastructure.Models.Image", "Tag")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .HasConstraintName("fk_experience_images_images_image_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
