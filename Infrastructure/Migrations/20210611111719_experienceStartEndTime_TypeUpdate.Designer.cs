...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210611111719_experienceStartEndTime_TypeUpdate")]
    partial class experienceStartEndTime_TypeUpdate
    {
            ...
            modelBuilder.Entity("Infrastructure.Models.Topic", b =>
                {
                    ...
                    b.HasIndex("ResumeId")
                        .HasName("ix_topics_resume_id");

                    b.HasIndex("UserId")
                        .HasName("ix_topics_user_id");
            ...
            modelBuilder.Entity("Infrastructure.Models.Topic_Experience", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_topic_experiences");

                    b.HasIndex("ExperienceId")
                        .HasName("ix_topic_experiences_experience_id");

                    b.HasIndex("TopicId")
                        .HasName("ix_topic_experiences_topic_id");

                    b.ToTable("topic_experiences");
                });
            ...
            modelBuilder.Entity("Infrastructure.Models.Topic", b =>
                {
                    b.HasOne("Infrastructure.Models.Resume", "Resume")
                        ...
                        .HasConstraintName("fk_topics_resumes_resume_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Models.Topic_Experience", b =>
                {
                    b.HasOne("Infrastructure.Models.Experience", "Experience")
                        .WithMany()
                        .HasForeignKey("ExperienceId")
                        .HasConstraintName("fk_topic_experiences_experiences_experience_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Infrastructure.Models.Topic", "Topic")
                        ...
                        .HasConstraintName("fk_topic_experiences_topics_topic_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
